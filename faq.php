...
<head>
    ...
    <title>Nekemte Nekemte City Resident ID - FAQ</title>
    ...
    <div class="container">
        ...
        - Proof of residency for various purposes within the city"
            ...
            array(
                ...
                "answer" => "The Nekemte City Resident ID Card is valid for a period of 3 years from the date of issuance. Cardholders are required to renew their cards before the expiration date to maintain their residency status and continue accessing city services and benefits."
            ),
            array(
            ...
            array(
                ...
                "answer" => "The Nekemte City Resident ID Card is valid for a period of 3 years from the date of issuance. Cardholders are required to renew their cards before the expiration date to maintain their residency status and continue accessing city services and benefits. The renewal process involves submitting an application and updated documentation to the Nekemte City Administration."
            ),
            array(
