...
<body>
    <div class="container">
        ...
        <div class="id-card">
            ...
            <h3 class="person-esential">Name: <?php echo $resident["full_name"]; ?> <span class="id-number bg-success "> ID :<?php echo $resident["national_id"]; ?> </span></h3>
            ...
            <div class="id-card-content">
                ...
                <div class="id-card-details">
                    ...
                    <p><span class="label"> Age:</span> <span class="value"><?php echo htmlspecialchars($resident["date_of_birth"]); ?></span></p>
                </div>
                <div class="id-card-details">
            ...
            <div class="barcode-qr-container">
                ...
                <div>
                    <p class="bg-danger"><span class="label">Expire:</span> <span class="value"><?php echo htmlspecialchars($resident["expiration_date"]); ?></span></p>
                </div>
