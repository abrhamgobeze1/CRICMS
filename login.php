...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user_type === "admin") {
        ...
        $sql = "SELECT km.kebeleModerator_id, km.username, km.password, k.kebele_id, k.kebele_name
...
<head>
    ...
    <title>Login - Nekemte City Resident ID</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <img class="justify-content-center border-radius-50" src="/CRICMS2/images/nekemte.jpg" alt="Company Logo" style="max-width: 100px; margin-bottom: 10px;">
                    ...
                    <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="user_type" name="user_type" required>
                                ...
                                <option value="moderator">Moderator [For City]</option>
                                <option value="kebeleModerator">Kebele Moderator [For Kebele]</option>
