...
│   └── admin_manage_blog.php: Page for admin to manage blog posts and comments.
│   
...
│   ├── moderator_manage_blog.php: Page for moderators to manage blog posts and comments.
│   └── moderator_approve_blog_comments.php: Page for moderators to approve or delete blog comments.
│   
...
│   ├── kebeleModerator_manage_blog.php: Page for kebeleModerators to manage blog posts and comments within their kebeles.
│   └── kebeleModerator_approve_blog_comments.php: Page for kebeleModerators to approve or delete blog comments within their kebeles.
│   
...
│   ├── resident_view_blog.php: Page for residents to view and interact with community blogs.
│   ├── resident_Manage_blog.php: Page for residents to create new blog posts , edit their blog post , delete their blog post.
│   └── resident_manage_comments.php: Page for residents to manage their comments on community blogs.
│   
